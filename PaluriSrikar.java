...
public class PaluriSrikar implements Player
{
    ...
    private int numberOfRsPending =1; //number of Rs to be counted before sending s
    private int currentCountOfRs =1;//keep track of current number of Rs
    /**
